...
class MenuCollectionViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    menuCollectionView.update(data: makeDummyMenuItems())
  }
  ...
  private func makeDummyMenuItems() -> [MenuItem] {
    return (0 ..< 100).map { MenuItem(title: "\($0)번째 메뉴") }
  }
}
